...
/* ─── Marketing Carousel ──────────────────────────────────── */
.od-mkt-carousel-section {
  background: linear-gradient(135deg, #07192c 0%, #0b2d4e 50%, #071828 100%);
  padding: 0;
  overflow: hidden;
  position: relative;
}
.od-mkt-carousel-section::before {
  content: '';
...
.od-mkt-carousel-section .carousel-inner { position: relative; z-index: 1; }
...
.od-mkt-slide .slide-icon-wrap {
  width: 72px; height: 72px; border-radius: 20px;
  display: flex; align-items: center; justify-content: center;
  margin: 0 auto 1.5rem;
  font-size: 1.75rem;
  background: rgba(26,138,78,.15);
  border: 1px solid rgba(26,138,78,.3);
  color: #4ade93;
  box-shadow: 0 0 32px rgba(26,138,78,.18);
}
.od-mkt-slide .slide-eyebrow {
  display: inline-block;
  font-size: .75rem; font-weight: 700; letter-spacing: 1.5px;
  text-transform: uppercase;
  color: #4ade93; margin-bottom: .75rem;
}
.od-mkt-slide h2 {
...
.od-mkt-slide h2 .hl {
  background: linear-gradient(135deg, #4ade93, #22d3a5);
  -webkit-background-clip: text; -webkit-text-fill-color: transparent;
  background-clip: text;
}
.od-mkt-slide .slide-sub {
  font-size: 1rem; color: rgba(255,255,255,.55);
  max-width: 560px; margin: 0 auto 2rem;
  line-height: 1.75; font-weight: 400;
}
.od-mkt-slide .slide-stats {
  display: flex; justify-content: center; gap: 3rem;
  flex-wrap: wrap; margin-bottom: 2.25rem;
}
.od-mkt-slide .stat-item { text-align: center; }
.od-mkt-slide .stat-num  {
  font-size: 2.2rem; font-weight: 900; color: white; line-height: 1;
  background: linear-gradient(135deg, #4ade93, #38bdf8);
  -webkit-background-clip: text; -webkit-text-fill-color: transparent;
  background-clip: text;
}
.od-mkt-slide .stat-lbl  { font-size: .75rem; color: rgba(255,255,255,.45); font-weight: 500; margin-top: .25rem; letter-spacing: .5px; }

/* Slide CTA link */
.od-mkt-slide .slide-cta {
  display: inline-flex; align-items: center; gap: .5rem;
  background: var(--od-green); color: white;
  padding: .65rem 1.5rem; border-radius: 8px;
  font-weight: 700; font-size: .875rem;
  text-decoration: none; transition: all .2s;
}
.od-mkt-slide .slide-cta:hover { background: #157a42; color: white; transform: translateY(-2px); box-shadow: 0 6px 20px rgba(26,138,78,.4); }
.od-mkt-slide .slide-cta-ghost {
  display: inline-flex; align-items: center; gap: .5rem;
...
.od-mkt-slide .slide-cta-ghost:hover { color: white; background: rgba(255,255,255,.08); border-color: rgba(255,255,255,.3); }

/* Pill tags */
.od-mkt-slide .slide-pills { display: flex; flex-wrap: wrap; justify-content: center; gap: .5rem; margin-bottom: 2rem; }
.od-mkt-slide .slide-pill {
  background: rgba(255,255,255,.06); border: 1px solid rgba(255,255,255,.12);
  color: rgba(255,255,255,.65); font-size: .78rem; font-weight: 600;
  padding: .3rem .85rem; border-radius: 50px;
}
.od-mkt-slide .slide-pill i { margin-right: .3rem; color: #4ade93; }

/* Carousel controls */
.od-mkt-carousel-section .carousel-control-prev,
.od-mkt-carousel-section .carousel-control-next {
  width: 48px; height: 48px; top: 50%; transform: translateY(-50%);
  border-radius: 50%; background: rgba(255,255,255,.08);
  border: 1px solid rgba(255,255,255,.12);
  opacity: 1; margin: 0 1rem;
  transition: all .2s;
}
.od-mkt-carousel-section .carousel-control-prev:hover,
.od-mkt-carousel-section .carousel-control-next:hover {
  background: rgba(26,138,78,.25); border-color: rgba(26,138,78,.5);
}
.od-mkt-carousel-section .carousel-control-prev-icon,
.od-mkt-carousel-section .carousel-control-next-icon {
  width: 18px; height: 18px;
}

/* Carousel indicators */
.od-mkt-carousel-section .carousel-indicators {
  bottom: 1.25rem; gap: .35rem; margin: 0;
}
.od-mkt-carousel-section .carousel-indicators button {
  width: 24px; height: 3px; border-radius: 2px;
  background: rgba(255,255,255,.25); border: none;
  transition: all .35s; opacity: 1;
}
.od-mkt-carousel-section .carousel-indicators button.active {
  width: 40px; background: var(--od-green);
}

/* Progress bar under the slide */
.od-slide-progress {
  position: absolute; bottom: 0; left: 0; height: 2px; z-index: 5;
  background: linear-gradient(90deg, #1A8A4E, #22d3a5);
  animation: slideProgress 5s linear infinite;
}
@keyframes slideProgress { from { width:0; } to { width:100%; } }

@media (max-width: 768px) {
  .od-mkt-slide { padding: 3.5rem 1rem 3rem; min-height: auto; }
  .od-mkt-slide .slide-stats { gap: 1.75rem; }
  .od-mkt-carousel-section .carousel-control-prev,
  .od-mkt-carousel-section .carousel-control-next { display: none; }
}
</style>
</head>
...
<!-- ══════════════════════════════════════════════════════════
     MARKETING CAROUSEL
══════════════════════════════════════════════════════════ -->
<section class="od-mkt-carousel-section">
  <div id="mktCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">

    <!-- Indicators -->
    <div class="carousel-indicators">
      <button type="button" data-bs-target="#mktCarousel" data-bs-slide-to="0" class="active"></button>
      <button type="button" data-bs-target="#mktCarousel" data-bs-slide-to="1"></button>
      <button type="button" data-bs-target="#mktCarousel" data-bs-slide-to="2"></button>
      <button type="button" data-bs-target="#mktCarousel" data-bs-slide-to="3"></button>
      <button type="button" data-bs-target="#mktCarousel" data-bs-slide-to="4"></button>
    </div>
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <div class="od-mkt-slide">
          <div class="container">
            <div class="slide-icon-wrap"><i class="fas fa-layer-group"></i></div>
            <div class="slide-eyebrow">All-in-One Platform</div>
            <h2>One Login. <span class="hl">22 Modules.</span><br>Unlimited Possibilities.</h2>
            <p class="slide-sub">Stop juggling disconnected tools. OrbitDesk brings your entire business — accounting, HR, POS, health clinic, school management and more — into a single, seamless workspace.</p>
            <div class="slide-stats">
              <div class="stat-item"><div class="stat-num">22+</div><div class="stat-lbl">Business Modules</div></div>
              <div class="stat-item"><div class="stat-num">500+</div><div class="stat-lbl">Businesses Served</div></div>
              <div class="stat-item"><div class="stat-num">14 Day</div><div class="stat-lbl">Free Trial</div></div>
            </div>
            <a href="<?= APP_URL ?>/auth/register.php" class="slide-cta"><i class="fas fa-rocket"></i> Get Started Free</a>
            <a href="#modules" class="slide-cta-ghost">Browse Modules <i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
        <div class="od-slide-progress"></div>
      </div>

      <!-- Slide 2: M-Pesa integration -->
      <div class="carousel-item">
        <div class="od-mkt-slide">
          <div class="container">
            <div class="slide-icon-wrap" style="background:rgba(74,222,147,.12);border-color:rgba(74,222,147,.3);color:#4ade93"><i class="fas fa-mobile-alt"></i></div>
            <div class="slide-eyebrow">Native M-Pesa Integration</div>
            <h2>Accept Payments the <span class="hl">African Way</span>.<br>Daraja API Built In.</h2>
            <p class="slide-sub">No third-party payment gateways. No extra fees. OrbitDesk ships with native M-Pesa STK push, real-time payment confirmation, and automated receipt generation across all billing modules.</p>
            <div class="slide-pills">
              <span class="slide-pill"><i class="fas fa-check"></i> STK Push Payments</span>
              <span class="slide-pill"><i class="fas fa-check"></i> Auto Receipts</span>
              <span class="slide-pill"><i class="fas fa-check"></i> Payment Reports</span>
              <span class="slide-pill"><i class="fas fa-check"></i> KopoKopo Ready</span>
              <span class="slide-pill"><i class="fas fa-check"></i> Multi-Branch</span>
            </div>
            <a href="<?= APP_URL ?>/auth/register.php" class="slide-cta"><i class="fas fa-mobile-alt"></i> Try It Free</a>
          </div>
        </div>
        <div class="od-slide-progress"></div>
      </div>

      <!-- Slide 3: Pricing / Africa-first -->
      <div class="carousel-item">
        <div class="od-mkt-slide">
          <div class="container">
            <div class="slide-icon-wrap" style="background:rgba(251,191,36,.1);border-color:rgba(251,191,36,.3);color:#fbbf24"><i class="fas fa-tags"></i></div>
            <div class="slide-eyebrow">Built for Africa. Priced for Africa.</div>
            <h2>Enterprise Power.<br><span class="hl">Local Pricing.</span> Zero Compromise.</h2>
            <p class="slide-sub">World-class ERP features at a fraction of global software costs. Plans start at KES 4,999/month — with M-Pesa billing, local support in your timezone, and servers you control.</p>
            <div class="slide-stats">
              <div class="stat-item"><div class="stat-num">KES 4,999</div><div class="stat-lbl">Starter / Month</div></div>
              <div class="stat-item"><div class="stat-num">17%</div><div class="stat-lbl">Annual Savings</div></div>
              <div class="stat-item"><div class="stat-num">8+</div><div class="stat-lbl">African Countries</div></div>
            </div>
            <a href="#pricing" class="slide-cta"><i class="fas fa-tag"></i> View Pricing</a>
            <a href="<?= APP_URL ?>/auth/register.php" class="slide-cta-ghost">Start Free Trial <i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
        <div class="od-slide-progress"></div>
      </div>

      <!-- Slide 4: Security & multi-tenant -->
      <div class="carousel-item">
        <div class="od-mkt-slide">
          <div class="container">
            <div class="slide-icon-wrap" style="background:rgba(59,130,246,.1);border-color:rgba(59,130,246,.3);color:#60a5fa"><i class="fas fa-shield-halved"></i></div>
            <div class="slide-eyebrow">Enterprise-Grade Security</div>
            <h2>Your Data. <span class="hl">Your Control.</span><br>Always Encrypted.</h2>
            <p class="slide-sub">AES-256 field encryption, CSRF protection, role-based access control, and a complete audit trail on every action. Host on our secure cloud or your own cPanel — the choice is yours.</p>
            <div class="slide-pills">
              <span class="slide-pill"><i class="fas fa-lock"></i> AES-256 Encryption</span>
              <span class="slide-pill"><i class="fas fa-users-cog"></i> Role-Based Access</span>
              <span class="slide-pill"><i class="fas fa-list-check"></i> Full Audit Logs</span>
              <span class="slide-pill"><i class="fas fa-server"></i> cPanel / Cloud Hosting</span>
              <span class="slide-pill"><i class="fas fa-building"></i> Multi-Tenant Ready</span>
            </div>
            <a href="<?= APP_URL ?>/auth/register.php" class="slide-cta"><i class="fas fa-shield-halved"></i> Start Secure Today</a>
          </div>
        </div>
        <div class="od-slide-progress"></div>
      </div>

      <!-- Slide 5: Mobile & support -->
      <div class="carousel-item">
        <div class="od-mkt-slide">
          <div class="container">
            <div class="slide-icon-wrap" style="background:rgba(168,85,247,.1);border-color:rgba(168,85,247,.3);color:#c084fc"><i class="fas fa-headset"></i></div>
            <div class="slide-eyebrow">Local Support, Global Standards</div>
            <h2>Run Your Business<br>From <span class="hl">Anywhere.</span> Get Help Instantly.</h2>
            <p class="slide-sub">Fully responsive and installable as a PWA on Android & iOS. Our Nairobi-based team is reachable via phone, WhatsApp, and email — Monday to Saturday, 8AM to 8PM EAT.</p>
            <div class="slide-stats">
              <div class="stat-item"><div class="stat-num">PWA</div><div class="stat-lbl">Works Offline</div></div>
              <div class="stat-item"><div class="stat-num">6 Days</div><div class="stat-lbl">Live Support</div></div>
              <div class="stat-item"><div class="stat-num">&lt; 2 Hr</div><div class="stat-lbl">Response Time</div></div>
            </div>
            <a href="#contact" class="slide-cta"><i class="fas fa-headset"></i> Talk to Us</a>
            <a href="<?= APP_URL ?>/auth/register.php" class="slide-cta-ghost">Start Free <i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
        <div class="od-slide-progress"></div>
      </div>
    ...
    <!-- Controls -->
    <button class="carousel-control-prev" type="button" data-bs-target="#mktCarousel" data-bs-slide="prev">
      <span class="carousel-control-prev-icon"></span>
      <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#mktCarousel" data-bs-slide="next">
...
// ── Marketing carousel: restart slide progress bar on each transition ──
(function () {
  const carousel = document.getElementById('mktCarousel');
  if (!carousel) return;
  function resetProgress() {
    carousel.querySelectorAll('.od-slide-progress').forEach(el => {
